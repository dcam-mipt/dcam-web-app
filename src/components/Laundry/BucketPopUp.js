...
import { Flex, Image, Extra, Text, Bar, BarWrapper, ClosePopUp } from '../UIKit/styled-templates'
    ...
    return (
        <BarWrapper>
            ...
            <Bar clear row extra={`width: 100%;`} onClick={() => { setSelectedSlots([]) }} >
                ...
                <Button backgroundColor={props => props.theme.accept} disabled={cost > props.balance} onClick={() => {
                    let a = selectedSlots
